...
values('Nam', 'Abc123', N'Lê Hoàng Nam', '0934519005', 'HoangNam@gmail.com', 0, N'TP. Hồ Chí Minh');
insert into KhachHang(TaiKhoanKH, MatKhauKH, HoVaTen, SDT,Email,GioiTinh,DiaChi) 
...
values (N'Lê Hoàng Nam', '03/02/2000', N'120 Nguyễn Tất Thành','0974521251', N'Đà Nẵng', N'Hải Châu', N'Thanh Khê', N'05/02/2000', 120000, 0,'Nam');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Lê Hoàng Nam', '05/02/2021', N'75 Tô Hoài','0974521251', N'Hà Nội', N'Ba Vì', N'Xã Ba Vì', N'08/02/2021', 300000, 0,'Nam');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Văn Thanh', '06/02/2021', N'12/2B Điện Biên Phủ','0974521251', N'Hà Nội', N'Ba Vì', N'Cẩm Lĩnh', N'09/02/2021', 600000, 0,'Nam');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Công Phượng', '07/02/2021', N'01 Lê Duẩn','0974521251', N'Đà Nẵng', N'Ba Vì', N'Ba Trại', N'12/02/2021', 700000, 0,'Nam');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Văn Lâm', '08/02/2021', N'93 Phan Đăng Lưu','0974521251', N'Hà Nội', N'ba Vì', N'Cổ Đô', N'09/02/2021', 1200000, 0,'Nam');
go
...
values('Nam', 1, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('Nam', 2, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('Nam', 3, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('Nam', 4, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('Nam', 5, 'Điện Thoại giá rẽ, chất lượng', default);
go
